package com.pers_assistant.shopping_list.feature.user_help.handling.ui
...
import com.pers_assistant.shopping_list.databinding.FragmentHandlingBinding
...
import com.pers_assistant.shopping_list.base.*
import com.pers_assistant.shopping_list.base.ProgressState.FINISHED
import com.pers_assistant.shopping_list.error.ViewError
import com.pers_assistant.shopping_list.feature.user_help.handling.viewmodel.HandlingViewModel.FieldValidation
import com.pers_assistant.shopping_list.feature.user_help.handling.viewmodel.HandlingViewModel.FieldValidation.*
import com.pers_assistant.shopping_list.util.EMAIL_DEVELOPER
import com.pers_assistant.shopping_list.util.getEventProgress
import com.pers_assistant.shopping_list.util.hideKeyboard
...
class HandlingFragment : AppBaseFragment(R.layout.fragment_handling), ViewError {
    ...
    private fun initViews() {
        ...
        binding.fragmentHandlingNameInputEditText.onFocusChangeListener =
            View.OnFocusChangeListener { _, hasFocus ->
                if (!hasFocus && messageFieldText().isNotEmpty()) validateInputs(TITLE)
            }
    ...
    private fun validateInputs(field: FieldValidation?) {
        when (field) {
            TITLE -> viewModel.validateTitle(name = nameFieldText())
    ...
    private fun sendEmail() {
        ...
        resultLauncher.launch(Intent.createChooser(email, "Выберите email клиент :"))
    }
